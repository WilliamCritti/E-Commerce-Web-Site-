                ...
                <form class="form" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="inputForm">
                        <svg aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none" viewBox="6 0 24 24">
                            <path stroke="currentColor" stroke-width="1.25"
                                d="M7 17v1a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1a3 3 0 0 0-3-3h-4a3 3 0 0 0-3 3Zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z">
                            </path>
                        </svg>
                            <input placeholder="Enter your Name" class="input m-0" type="text" name="name" id="name">
                    </div>
                    <div class="flex-column">
                    ...
                    <div class="inputForm">
                        ...
                        <input placeholder="Re-enter your Password" class="input" type="password"
